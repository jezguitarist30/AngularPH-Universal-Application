...
export class HomeComponent implements OnInit {
  ...
  about: string = `We are Filipino developers that loves to code and share. 
  ...
  We help each other and improve our selves with team work. 
  We choose Angular as our weapon of choice in building web applications, but even though we choose Angular doesn't mean 
  we are not open to other frameworks such as React, Vue and other awesome technology out there. We promote the use of other technologies and let the people decide.`;
